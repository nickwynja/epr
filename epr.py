...
SCROLL_UP_K = {ord("k")}
PARA_DOWN = {ord("e"), ord(" "), ord("\n")}
HALF_DOWN = {4}
HALF_UP = {21}
PAGE_DOWN = {ord("l"), ord(" "), curses.KEY_RIGHT}
PAGE_UP = {ord("h"), curses.KEY_LEFT}
CH_NEXT = {curses.KEY_NPAGE, ord("n")}
CH_PREV = {curses.KEY_PPAGE, ord("p")}
